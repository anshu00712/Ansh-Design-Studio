...
(function(i, l, n, g) {
    ...
    c.Pipe = [{
        ...
        filter: ["items", "settings"],
        run: function() {
            var q, t, r = this._clones, e = this._items, s = this.settings.loop ? r.length - Math.max(this.settings.items * 2, 4) : 0;
            for (q = 0,
            t = Math.abs(s / 2); q < t; q++) {
                if (s > 0) {
        ...
        filter: ["width", "items", "settings"],
        run: function() {
            var r = (this.settings.rtl ? 1 : -1), q = (this.width() / this.settings.items).toFixed(3), u = 0, t, e, s;
            this._coordinates = [];
            for (e = 0,
            s = this._clones.length + this._items.length; e < s; e++) {
        ...
        run: function() {
            ...
            if (!this.settings.autoWidth && i.grep(this._mergers, function(t) {
                ...
                for (q = 0,
                s = this._coordinates.length; q < s; q++) {
        ...
        run: function() {
            var u = this.settings.rtl ? 1 : -1, v = this.settings.stagePadding * 2, q = this.coordinates(this.current()) + v, r = q + this.width() * u, x, w, t = [], s, e;
            for (s = 0,
            e = this._coordinates.length; s < e; s++) {
...
(function(d, b, a, e) {
    ...
    ;
    c.prototype.update = function() {
        var n, l, f, h = this._core.settings, g = this._core.clones().length / 2, o = g + this._core.items().length, m = h.center || h.autoWidth || h.dotData ? 1 : h.dotsEach || h.items;
        if (h.slideBy !== "page") {
    ...
    c.prototype.draw = function() {
        var l, j, h = "", g = this._core.settings, k = this._core.$stage.children(), f = this._core.relative(this._core.current());
